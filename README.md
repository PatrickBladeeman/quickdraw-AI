...
- Python 3.10.12 historical CPU transport reference plus the Python 3.11.13 / PyTorch 2.12.0 R3A/R3B CPU foundation and optimizer smoke, and the accepted ROCm inference lane (trainer rollout not yet implemented)
