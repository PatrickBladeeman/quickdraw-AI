...
- Python 3.10.12 historical CPU transport reference plus the Python 3.11.13 / PyTorch 2.12.0 R3A-R3H BDQ foundation, optimizer, direct LLAPI collection, first two scheduled live updates, post-update policy handoff, and accepted ROCm inference lane (extended training not yet implemented)
