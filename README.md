...
- Python 3.10.12 historical CPU transport reference plus the Python 3.11.13 / PyTorch 2.12.0 R3A-R3M BDQ foundation, optimizer, direct LLAPI collection, first four scheduled live updates, update-3 policy handoff, bounded live production-epsilon integration, and accepted ROCm inference lane (extended training not yet implemented)
