...
- Multi-environment Unity collection, an extended environment learning loop, epsilon-decay rollout, checkpoint/export lifecycle, learned-policy evaluation, or trained policies. R3G deliberately stops after its second Unity-derived optimizer update. R1F accepts ROCm only for its fixed-policy inference fixture.
