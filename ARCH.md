...
- `Research/trainer/quickdraw_bdq` — R3A replay/action/network/target foundation,
  ...
  gate, R3G second-update gate, and R3H post-update handoff gate. The former ML-Agents trainer, policy,
  trajectory, settings,
...
Research/                                (non-Unity research source and contracts)
  ...
  trainer/                               (R3A foundation through R3H policy handoff)
  analysis/                              (planned)
